...
#define CENTER_FREQ_TOLERANCE           10     //Faixa na qual a frequencia È considerada atingida pelo experimento.
...
#endif
{
		...
		setOutput(1,0,low);
                ...
                // Se eu recebo novamente a _START_STOP_FLAG, ent„o para o exp.
        	isEnabled = 0;
                tempVar = 0;
          	setOutput(1,1,low);
		setOutput(1,0,high);
